...
and recorded experience; an event is a fact about Urdyn's own history (a
...
Internal to Urdyn: not part of the public API. Its identity is a uuid4
...
class Event:
    ...
    when Urdyn recorded the event, in UTC.
    """
